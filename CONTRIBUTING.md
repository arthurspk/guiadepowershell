# Como contribuir com o Guia de PowerShell
...
3. **Descrição de 1 linha** dizendo o que é e por que vale o clique (quando o nome já não for autoexplicativo). Se o recurso for pago, diga isso na própria descrição.
...
1. Faça um fork e crie uma branch a partir da `main` (ex.: `feat/novo-curso-dsc`).
2. Edite o `README.md`.
